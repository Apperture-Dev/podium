# Plantilla de build para lang=nodejs, framework=react.
...
#
# dist/ con fallback a build/: Vite emite dist/, Create React App emite
# build/. El `try_files ... /index.html` es lo que hace que una ruta de la
# SPA abierta en frío no devuelva 404.
#
