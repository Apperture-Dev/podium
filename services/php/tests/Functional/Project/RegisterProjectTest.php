...
final class RegisterProjectTest extends FunctionalTestCase
{
    public function testRegisteringAProjectRequiresAnExistingTeam(): void
    {
        ...
        $this->postJson('/api/projects', ['repositoryUrl' => 'https://github.com/team/repo', 'teamId' => $teamId]);
    ...
    {
        $this->postJson('/api/projects', ['repositoryUrl' => 'https://github.com/team/repo', 'teamId' => '01997e3a-0000-7000-8000-000000000000']);
